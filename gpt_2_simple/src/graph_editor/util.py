...
from tensorflow.python.ops import array_ops as tf_array_ops #pylint:disable=no-name-in-module
from tensorflow.python.util.compat import collections_abc   #pylint:disable=no-name-in-module
